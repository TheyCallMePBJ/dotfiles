...
hl.bind("SUPER + G", hl.dsp.exec_cmd("signal_desktop"))
...
hl.bind("SUPER + Escape", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call sessionMenu toggle"))
hl.bind("SUPER + A", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call controlCenter toggle"))
hl.bind("SUPER + I", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call settings toggle"))
hl.bind("SUPER + N", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call notifications toggleHistory"))
hl.bind("CTRL + ALT + X", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call launcher clipboard"))

hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call brightness increase"), {lock=true})
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call brightness decrease"), {lock=true})
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call volume increase"), {lock=true})
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call volume decrease"), {lock=true})
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call volume muteOutput"), {lock=true})

hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call media playPause"), {lock=true})
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call media pause"), {lock=true})
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call media next"), {lock=true})
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call media previous"), {lock=true})

hl.bind("SUPER + ALT + L", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call sessionMenu lockAndSuspend"))
